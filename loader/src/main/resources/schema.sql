...
ALTER TABLE ACCT PARTITION BY LIST (STATE) (PARTITION east VALUES IN ('SC'), PARTITION central VALUES IN ('TX'), PARTITION west VALUES IN ('CA'));
...
ALTER TABLE AUTH PARTITION BY LIST (STATE) (PARTITION east VALUES IN ('SC'), PARTITION central VALUES IN ('TX'), PARTITION west VALUES IN ('CA'));
